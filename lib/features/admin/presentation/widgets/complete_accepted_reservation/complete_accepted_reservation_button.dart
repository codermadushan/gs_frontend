...
class CompleteAcceptedReservationButton extends StatefulWidget {
  final VoidCallback _onPressed;

  const CompleteAcceptedReservationButton({
    super.key,
    required VoidCallback onPressed,
  }) : _onPressed = onPressed;

  @override
  State<CompleteAcceptedReservationButton> createState() =>
      _CompleteAcceptedReservationButtonState();
}

class _CompleteAcceptedReservationButtonState
    extends State<CompleteAcceptedReservationButton> {
