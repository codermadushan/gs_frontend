...
class RejectPendingReservationButton extends StatefulWidget {
  final VoidCallback _onPressed;

  const RejectPendingReservationButton({
    super.key,
    required VoidCallback onPressed,
  }) : _onPressed = onPressed;

  @override
  State<RejectPendingReservationButton> createState() =>
      _RejectPendingReservationButtonState();
}

class _RejectPendingReservationButtonState
    extends State<RejectPendingReservationButton> {
